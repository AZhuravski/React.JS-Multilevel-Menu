...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOSSIERS = __webpack_require__(159);

	var GlobalMenuButton = __webpack_require__(160);

	React.render(React.createElement(GlobalMenuButton, null), document.getElementsByTagName('body')[0]);

	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\-- AZ --\\myProject\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports) {
	...
	module.exports = [
		{
			"name": "Sunscreen composition comprising color pigments",
			"company": "BASF SE",
			"number": "EP 13 198 908.9 (EN)",
			"specialist": "1st Examiner",
			"date": "23.04.2015"
		},
		{
			"name": "Oral Care Toothbrush",
			"company": "Sony Inc.",
			"number": "EP 13 198 908.9 (EN)",
			"specialist": "1st Examiner",
			"date": "24.04.2015"
		},
		{
			...
			"company": "BASF SE",
			"number": "Euro PCTbis",
			"specialist": "2st Examiner",
			"date": "21.04.2015"
		},
		{
			"name": "Event Handling and Synthetic Events",
			"company": "BASF SE",
			"number": "EP 13 198 908.9 (EN)",
			"specialist": "2st Examiner",
			"date": "17.04.2015"
		...
		{
			"name": "Two-Way Binding Helpers",
			"company": "Faberge Company",
			"number": "EP 13 198 908.9 (EN)",
			"specialist": "Chairman",
			"date": "19.03.2015"
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GlobalMenu = __webpack_require__(161);

	var React = __webpack_require__(3);

	var APPLICATIONS = __webpack_require__(169);

	var POPUPLINKS = __webpack_require__(170);

	var GlobalMenuButton = React.createClass({
	  displayName: 'GlobalMenuButton',
	  ...
	  handleUserInput: function handleUserInput(activeapp) {
	    this.setState({
	      activeapp: activeapp
	    });
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { id: 'divdiv' },
	      React.createElement('div', { onClick: this.toggleActive, className: "globalmenu-icon" }),
	      React.createElement(
	        'div',
	        { className: "globalmenu-selected" },
	        React.createElement(
	          'b',
	          null,
	      ...
	      React.createElement(GlobalMenu, { applications: APPLICATIONS, popuplinks: POPUPLINKS, activeapp: this.state.activeapp, globalmenubutton: this.state.active, onUserInput: this.handleUserInput, toggle: this.toggleActive })
	    );
	  }
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\-- AZ --\\myProject\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "GlobalMenuButton.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PopupLink = __webpack_require__(162);
	var SearchBar = __webpack_require__(166);
	var SettingsBar = __webpack_require__(168);
	var React = __webpack_require__(3);
	...
	var GlobalMenu = React.createClass({
	  ...
	  handlePopupLinkInput: function handlePopupLinkInput(activepopuplink) {
	    this.setState({
	  ...
	  render: function render() {
	    ...
	    this.props.applications.forEach((function (application) {
	      approws.push(React.createElement(App, { application: application,
	    ...
	    this.props.popuplinks.forEach((function (popuplink) {
	      poprows.push(React.createElement(PopupLink, { popuplink: popuplink,
	        activeapp: this.props.activeapp,
	    ...
	    return React.createElement(
	      ...
	      approws,
	      React.createElement('div', { className: "whitespace" }),
	      poprows,
	      React.createElement(SearchBar, { activeapp: this.props.activeapp, onUserInput: this.handleUserInput }),
	      React.createElement(SettingsBar, { activeapp: this.props.activeapp, onUserInput: this.handleUserInput })
	    );
	  }
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\-- AZ --\\myProject\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "GlobalMenu.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DossiersList = __webpack_require__(163);

	var React = __webpack_require__(3);

	//var DOSSIERS = require('../json/dossiers.json');

	var PREVIOUSDOSSIERS = __webpack_require__(165);
	...
	var PopupLink = React.createClass({
	  ...
	  handleUserInputTwo: function handleUserInputTwo() {
	    this.props.onUserInputTwo(this.props.popuplink.name);
	  },
	  ...
	  render: function render() {
	    ...
	    if (this.props.popuplink.name == this.props.activepopuplink) {
	      var dossiersList = this.props.activepopuplink == 'Currently open dossiers' ? React.createElement(DossiersList, { dossiers: DOSSIERS,
	        activepopuplink: this.props.activepopuplink,
	        onUserInput: this.handleUserInput }) : this.props.activepopuplink == 'Previously viewed' ? React.createElement(DossiersList, { dossiers: PREVIOUSDOSSIERS,
	        activepopuplink: this.props.activepopuplink,
	    ...
	    return React.createElement(
	      'div',
	      { className: popuplinkClass, onClick: this.handleUserInputTwo },
	      React.createElement(
	        'table',
	        null,
	        React.createElement(
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\-- AZ --\\myProject\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "PopupLink.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dossier = __webpack_require__(164);
	var React = __webpack_require__(3);

	var DossiersList = React.createClass({
	  displayName: 'DossiersList',

	  handleUserInput: function handleUserInput(activeapp) {
	    this.props.onUserInput(activeapp);
	  },

	  handleCloseButton: function handleCloseButton(dossier) {
	  ...
	  render: function render() {
	    ...
	    if (this.props.activepopuplink == 'Currently open dossiers') {
	      ...
	      closeAll = this.props.dossiers.length ? React.createElement(
	        'div',
	        { className: "dos-closeall", onClick: this.handleCloseAll },
	        'Close all'
	      ) : '';

	      nothingToShow = !this.props.dossiers.length ? React.createElement(
	        'div',
	        { className: "dos-closeall" },
	        'Ooops! You killed them all.'
	      ) : '';
	    }

	    this.props.dossiers.forEach((function (dossier) {
	      dosrows.push(React.createElement(Dossier, { dossier: dossier,
	        activepopuplink: this.props.activepopuplink,
	        onUserInput: this.handleUserInput,
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\-- AZ --\\myProject\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "DossiersList.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dossier = React.createClass({
	  ...
	  handleUserInputs: function handleUserInputs(event) {
	    var target = event.target;
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: dosClass, onClick: this.handleUserInputs },
	      React.createElement('div', { className: "dos-icon" }),
	      React.createElement(
	        'div',
	        { className: "dos-section" },
	        React.createElement(
	          'table',
	          { className: "dos-table" },
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'a',
	                { className: 'dos-name-a', href: "#" },
	                this.props.dossier.name
	              )
	            ),
	            React.createElement(
	              'td',
	              { rowSpan: "2", className: dosIconClose, id: 'dossier-close-button' },
	              'X'
	            )
	          ),
	          React.createElement(
	            ...
	            React.createElement(
	              'td',
	              { className: "dossier-company" },
	              this.props.dossier.company
	            )
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'td',
	              { colSpan: "2", className: "dos-specialist" },
	              this.props.dossier.specialist
	            )
	          ),
	          React.createElement(
	            'tr',
	            ...
	            React.createElement(
	              'td',
	              { className: "dos-number" },
	              this.props.dossier.number
	            ),
	            React.createElement(
	              'td',
	              { className: "dos-date" },
	              'Lim.Date ',
	              this.props.dossier.date
	            )
	          )
	        )
	      )
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\-- AZ --\\myProject\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Dossier.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports) {
	...
	module.exports = [
		...
		{
			"name": "Colgate-Palmolive Toothbrush",
		...
		{
			"name": "DOM Event Listeners in a Component",
			"company": "ReactJS",
			"number": "Euro PCTbis",
			"specialist": "2st Examiner",
			"date": "30.01.2013"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchBar = React.createClass({
	  ...
	  handleChange: function handleChange() {
	    this.props.onUserInput("Searchbar");
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: searchbarClass, onClick: this.handleChange },
	      React.createElement(
	        'form',
	        null,
	        React.createElement('input', { type: "text", className: "searchform", placeholder: "  Enter a dossier number ..." })
	      )
	    );
	  }
	});
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\-- AZ --\\myProject\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SearchBar.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	  ...
	  handleChange: function handleChange() {
	    this.props.onUserInput(this.props.application.name);
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: appClass, onClick: this.handleChange },
	      React.createElement(
	        'table',
	        null,
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            this.props.application.shortName
	          ),
	          React.createElement(
	            'td',
	            { className: "app-name" },
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'div',
	              { className: appCirClass },
	              this.props.application.number1
	            )
	          ),
	          React.createElement(
	            'td',
	            { className: appAmountClass },
	            React.createElement(
	              'span',
	              { className: 'bold' },
	              this.props.application.number2
	            ),
	            ' / ',
	            this.props.application.number3
	          )
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingsBar = React.createClass({
	  ...
	  handleChange: function handleChange() {
	    this.props.onUserInput("Settings");
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: settingsbarClass, onClick: this.handleChange },
	      'Settings'
	    );
	  }
	});
	...
	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("C:\\-- AZ --\\myProject\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SettingsBar.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(__resourceQuery) {var io = __webpack_require__(172);
	var stripAnsi = __webpack_require__(224);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var object = __webpack_require__(222);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseuri = __webpack_require__(214);
